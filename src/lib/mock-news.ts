...
export const INDIA_STATES: StateInfo[] = [
  ...
  { name: "Andhra Pradesh", code: "AP", lat: 16.50, lng: 80.64, capital: "Amaravati" },
  { name: "Arunachal Pradesh", code: "AR", lat: 27.10, lng: 93.61, capital: "Itanagar" },
  { name: "Chhattisgarh", code: "CG", lat: 21.25, lng: 81.62, capital: "Raipur" },
  { name: "Goa", code: "GA", lat: 15.49, lng: 73.82, capital: "Panaji" },
  { name: "Haryana", code: "HR", lat: 30.73, lng: 76.77, capital: "Chandigarh" },
  { name: "Jharkhand", code: "JH", lat: 23.34, lng: 85.30, capital: "Ranchi" },
  { name: "Manipur", code: "MN", lat: 24.81, lng: 93.93, capital: "Imphal" },
  { name: "Meghalaya", code: "ML", lat: 25.57, lng: 91.88, capital: "Shillong" },
  { name: "Mizoram", code: "MZ", lat: 23.72, lng: 92.71, capital: "Aizawl" },
  { name: "Nagaland", code: "NL", lat: 25.67, lng: 94.10, capital: "Kohima" },
  { name: "Sikkim", code: "SK", lat: 27.33, lng: 88.61, capital: "Gangtok" },
  { name: "Tripura", code: "TR", lat: 23.83, lng: 91.28, capital: "Agartala" },
  { name: "Andaman and Nicobar", code: "AN", lat: 11.62, lng: 92.72, capital: "Port Blair" },
  { name: "Chandigarh", code: "CH", lat: 30.73, lng: 76.77, capital: "Chandigarh" },
  { name: "Dadra and Nagar Haveli", code: "DN", lat: 20.27, lng: 73.01, capital: "Silvassa" },
  { name: "Daman and Diu", code: "DD", lat: 20.39, lng: 72.83, capital: "Daman" },
  { name: "Lakshadweep", code: "LD", lat: 10.56, lng: 72.64, capital: "Kavaratti" },
  { name: "Puducherry", code: "PY", lat: 11.94, lng: 79.80, capital: "Puducherry" },
];
